...
type Settings = { silver_breakout_points: number; sl_points: number; target_points: number; tsl_activate_points: number; tsl_buffer_points: number; silver_lots: number; size_mode: 'lots' | 'pax'; pax_size: number; leverage: number; post_exit_cooldown_minutes: number; exit_mode: string; strategy_version: string };
...
const initial: Settings = { silver_breakout_points: 3, sl_points: 15, target_points: 50, tsl_activate_points: 15, tsl_buffer_points: 3, silver_lots: 1, size_mode: 'lots', pax_size: 0.001, leverage: 50, post_exit_cooldown_minutes: 5, exit_mode: 'fixed_target_sl', strategy_version: 'paxg_ema_volume_v1' };
