...
def disconnect_broker_tokens(mode: str | None = None, *, source: str = "manual_ui") -> None:
    ...
    audit_log("fyers", "broker tokens disconnected", mode=mode or "runtime", broker=broker_key, source=source)
